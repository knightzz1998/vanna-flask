...
vn = MyVanna(config={'api_key': os.environ.get('API_KEY'),
                     'model': os.environ.get('MODEL'),
                     'base_url':os.environ.get('MODEL')})

# 从环境变量中获取 Snowflake 连接信息并连接到 Snowflake
...
vn.connect_to_postgres(host=os.environ.get('PG_HOST'),
